...
{{-- Evaluation Form --}}
<form method="POST" action="{{ route('evaluate.store') }}" onsubmit="event.preventDefault(); showConfirm('Submit this evaluation? This cannot be undone.', this, {safe: true, confirmText: 'Submit'})">
    @csrf
