...
{{-- Evaluation Form --}}
<form method="POST" action="{{ route('evaluate.store') }}" id="evalForm" onsubmit="event.preventDefault(); showConfirm('Submit your evaluation? This cannot be undone.', this, {safe: true, confirmText: 'Submit'})">
    @csrf
