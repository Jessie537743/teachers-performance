...
@can('view-analytics')
    ...
    @else
        <a href="{{ route('plan.upgrade', ['feature' => 'ai_predictions']) }}" class="flex items-center justify-between gap-3 px-3.5 py-2.5 rounded-xl mb-1 text-sm text-white/55 hover:bg-white/10 hover:text-white/85 transition group">
            <span>Analytics</span>
            <span class="text-[10px] uppercase tracking-wider px-1.5 py-0.5 rounded bg-amber-400/20 text-amber-200 ring-1 ring-amber-300/30">Pro</span>
        </a>
    @endplan
@endcan
...
<a href="{{ route('api-integration.index') }}" class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl mb-1 text-sm transition-all duration-200 {{ request()->routeIs('api-integration.*') ? 'bg-white/15 text-white border-l-[3px] border-blue-400 pl-[11px]' : 'text-white/85 hover:bg-white/10 hover:text-white hover:translate-x-1' }}">API Integration</a>
@endcan
@can('manage-settings')
...
@endcan
<a href="{{ route('announcements.index') }}" class="flex items-center justify-between px-3.5 py-2.5 rounded-xl mb-1 text-sm transition-all duration-200 {{ request()->routeIs('announcements.index', 'announcements.show') ? 'bg-white/15 text-white border-l-[3px] border-blue-400 pl-[11px]' : 'text-white/85 hover:bg-white/10 hover:text-white hover:translate-x-1' }}">
