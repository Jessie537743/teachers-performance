...
<head>
    ...
    {{-- Favicon: SVG primary (sharp at every density), ICO fallback for legacy
         browsers, Apple touch icon for iOS bookmarks. All paths resolve through
         asset() which now produces clean URLs (no tenant prefix) because
         tenancy.filesystem.asset_helper_tenancy is disabled. --}}
